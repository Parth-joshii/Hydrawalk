  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-screen bg-[#f8fafd] dark:bg-[#0c0d0e] text-slate-900 dark:text-slate-100 selection:bg-blue-500/30 overflow-hidden font-sans relative">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative z-10">
        ...
        {/* Mobile Pause/Resume Floating Bar (visible only on mobile) */}
        <div className="flex md:hidden px-4 pb-1 pt-2 bg-white/95 dark:bg-[#131314]/95 backdrop-blur-md border-t border-[#e3e3e3] dark:border-slate-800/60">
          <button
            onClick={() => togglePause()}
            className={`w-full py-2 px-4 rounded-xl text-xs font-bold transition-all border flex items-center justify-center gap-2 cursor-pointer active:scale-95 ${isPaused
